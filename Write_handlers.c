...
/**
 * write_num - Write a num use a bufffer
 * @ind: Index at which the number starts on the buffer
 * @buffer: to print Buffer
 * @flags: to print Flags
 * @width: get width
 * @prec: Precision specified
 * @length: Num length
 * @padd: Padding characters
 * @extra_c: Extra character
 * Return: Num  printed characters.
 */
...
/**
 * write_unsgnd - Writes a unsigned num
 * @is_negative: Num indicating if the num is negative
 * @ind: Index  which the num starts in the buffer
 ...
 * @padd_start: Index at which padd should to start
 *
